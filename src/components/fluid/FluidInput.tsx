...
export function FluidInput({ icon, className, ...props }: FluidInputProps) {
  return (
    <motion.label
      className="group relative flex h-11 items-center gap-2 rounded-xl bg-background/55 px-3 ring-1 ring-border/70 transition-colors hover:bg-background focus-within:bg-background focus-within:ring-ring/45"
      whileHover={{ y: -1 }}
